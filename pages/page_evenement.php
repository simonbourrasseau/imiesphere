...
<!-- Créer un article-->
<a href="./page_creation_evenement.php">
<button id="creation_evenement">Créer un evenement</button>
</a><br>
...
$requete_evenement = $bdd->query("SELECT * FROM evenement");

while ($data = $requete_evenement->fetch()){
    ?><h1><?php echo $data['titre'];?></h1>
		<h2><?php echo $data['campus'];?></h2><?php
		echo "<img id='article_image' src=".$data['image'].">"; ?><br><br> <?php
    echo "<p id='article_text'>".$data['description']."</p>";?><br><br><?php
}
?>
</div>
